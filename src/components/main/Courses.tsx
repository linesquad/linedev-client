...
function Courses() {
  return (
    <div className="text-white p-8 my-16 mb-40 relative overflow-hidden">
      <div className="relative z-10">
        <div className="absolute inset-0 w-full h-full top-30">
          ...
          <div className="absolute bottom-40 left-60 aspect-square bg-radial-gradient bg-[#171435] rounded-full w-[300px] h-[300px] blur-2xl"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {courses.map((course) => (
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-2xl mb-4 bg-gradient-to-r text-white bg-clip-text">
                  {course.title}
                </h2>
              ...
              <div className="flex items-center mt-6 relative z-10">
                <div
                  className={`${course.iconBg} p-3 rounded-lg bg-opacity-80 backdrop-blur-sm`}
                >
                  <svg
