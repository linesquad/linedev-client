...
function Header({ user, onLogout }: HeaderProps) {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-50 border-b border-[#252134] bg-[#0E0C15]/60 backdrop-blur-sm text-gray-400 transition-all duration-300 ${scrolled ? "py-3" : "py-5"}`}
    >
